 	...
 	<div class="blank">
			...
			<div class="row">
				<div class="col-md-12 text-right" style="margin-top:20px; margin-bottom:20px;">
					<?php echo anchor(site_url("pembeli/tambah_pembeli"),'<i class="fa fa-plus"></i>', 'class="btn btn-primary"');?>
				</div>
			</div>
			<div class="row"">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center" style="vertical-align:middle;"><?php echo $value->nohp_pembeli;?></td>
						<td align="center" style="vertical-align:middle;">
						<?php echo anchor(site_url("pembeli/edit/".$value->kode_pembeli),
					'<i class="fa fa-pencil"></i>', 
					'class="btn btn-default"');?>
						<?php echo anchor(site_url("pembeli/delete/".$value->kode_pembeli),
