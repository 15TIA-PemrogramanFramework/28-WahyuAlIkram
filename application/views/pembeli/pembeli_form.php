			...
			<div class="tab-pane active" id="horizontal-form">
				<form class="form-horizontal" action="<?php echo $action;?>" method="POST">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" name="nama_pembeli" class="form-control1" id="focusedinput" placeholder="" value="<?php echo $nama_pembeli;?>">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="focusedinput" class="col-sm-2 control-label">NoHp Pembeli</label>
						<div class="col-sm-8">
							<input type="text" name="nohp_pembeli" class="form-control1" id="focusedinput" placeholder="" value="<?php echo $nohp_pembeli;?>">
						</div>
					</div>
					<input type="hidden" name="kode_pembeli" value="<?php echo $kode_pembeli ?>">
				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2" style="margin-top:15px;">
						<center>
							...
							<a href="<?php echo site_url('pembeli'); ?>" class="btn btn-default">Kembali</a>
