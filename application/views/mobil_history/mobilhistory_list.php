	...
	<div class="blank-page" style="padding-right:40px; padding-left:40px;">
		<div class="row">
			...
			<div class="col-md-12 text-right" style="margin-top:20px; margin-bottom:20px;">
				<?php echo anchor(site_url("mobil_history/tambah_mobil_history"),'<i class="fa fa-plus"></i>', 'class="btn btn-primary"');?>
			</div>
			<?php } ?>
		</div>
		<div class="row"">
			<table id="example" class="table table-striped table-bordered">
				<thead>
					<tr>
						<th width="5%" style="text-align:center;">Kode Mobil History</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center" style="vertical-align:middle;">
							...
							<?php echo anchor(site_url("mobil_history/beli_mobil/".$value->kode_mobil),
								'<i class="fa fa-trash"></i>', 
								'class="btn btn-default"');?>
								<?php } ?>
							<?php if($status == 'dealer') { ?>
							<?php echo anchor(site_url("mobil_history/edit/".$value->kode_mobil),
								'<i class="fa fa-pencil"></i>', 
								'class="btn btn-default"');?>
							<?php echo anchor(site_url("mobil_history/delete/".$value->kode_mobil),
								'<i class="fa fa-trash"></i>', 
								'class="btn btn-default"');?>
							</td><?php }} ?>	
						</tr>
