			...
			<div class="row"">
				...
				<thead>
					<tr>
						...
						<th style="text-align:center; vertical-align:middle;">Tanggal Pemasukkan</th>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center" style="vertical-align:middle;"><?php echo $value->tanggal_pemasukkan;?></td>
						<td align="center" style="vertical-align:middle;"><?php echo $value->harga;?></td>
						<?php if($this->session->userdata('status') == 'dealer') { ?>
						<td align="center" style="vertical-align:middle;">
						<?php echo anchor(site_url("pemasukkan/delete/".$value->kode_pemasukkan),
