						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<?php echo $action;?>" method="POST">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="nama_supplier" class="form-control1" id="focusedinput" placeholder="" value="<?php echo $nama_supplier;?>">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">NoHp Supplier</label>
									<div class="col-sm-8">
										<input type="text" name="nohp_supplier" class="form-control1" id="focusedinput" placeholder="" value="<?php echo $nohp_supplier;?>">
									</div>
								</div>
						</div>
					</div>
      ...
      <div class="panel-footer">
		<div class="row">
			...
			<center>
				...
				<a href="<?php echo site_url('supplier'); ?>" class="btn btn-default">Kembali</a>
